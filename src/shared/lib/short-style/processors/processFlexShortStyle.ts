import { isdef, ifBool, type Pu } from '@utils/ts/ts.ts'
...
export type FlexShortStyle = Pu<{
  ...
  rowCenter: boolean // true => { flexDirection: 'row', alignItems: 'center' }
  rowEnd: boolean // true => { flexDirection: 'row', alignItems: 'end' }
  rowStretch: boolean // true => { flexDirection: 'row', alignItems: 'stretch' }
  colStart: boolean // true => { flexDirection: 'column', alignItems: 'start' }
  colCenter: boolean // true => { flexDirection: 'column', alignItems: 'center' }
  colStretch: boolean // true => { flexDirection: 'column', alignItems: 'stretch' }
...
export const processFlexShortStyle = <P extends object>(
  ...
  const {
    ...
    rowCenter, rowEnd, rowStretch, colStart, colCenter, colStretch,
  ...
  const flexCss = {
    ...
    ...rowEnd && { flexDirection: 'row' as const, alignItems: 'end' },
    ...rowStretch && { flexDirection: 'row' as const, alignItems: 'stretch' },
    ...colStart && { flexDirection: 'column' as const, alignItems: 'start' },
    ...colCenter && { flexDirection: 'column' as const, alignItems: 'center' },
    ...colStretch && { flexDirection: 'column' as const, alignItems: 'stretch' },
